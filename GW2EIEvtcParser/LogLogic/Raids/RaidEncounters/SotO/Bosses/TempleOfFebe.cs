...
internal class TempleOfFebe : SecretOfTheObscureRaidEncounter
{
    ...
    public TempleOfFebe(int triggerID) : base(triggerID)
    {
        MechanicList.Add(new MechanicGroup([
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Insatiable, new (Symbols.Hourglass, Colors.Pink), "Ins.A", "Insatiable Applied (Absorbed Gluttony Orb)", "Insatiable Application", Sev1, 0),
                new EnemyCastStartMechanic([InsatiableHungerSmallOrbSkillNM, InsatiableHungerSmallOrbEmpoweredSkillNM, InsatiableHungerSmallOrbSkillCM, InsatiableHungerSmallOrbEmpoweredSkillCM], new (Symbols.HourglassOpen, Colors.Pink), "InsHun.C", "Casted Insatiable Hunger", "Insatiable Hunger Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([CrushingRegretNM, CrushingRegretCM], new (Symbols.Circle, Colors.DarkGreen), "CrushReg.H", "Hit by Crushing Regret (Green)", "Crushing Regret Hit", Sev2, 0),
                new PlayerDstHealthDamageHitMechanic([CrushingRegretEmpoweredNM, CrushingRegretEmpoweredCM], new (Symbols.Circle, Colors.GreenishYellow), "Emp.CrushReg.H", "Hit by Empowered Crushing Regret (Green)", "Empowered Crushing Regret Hit", Sev2, 0),
                new PlayerDstEffectMechanic(EffectGUIDs.TempleOfFebeCerusGreen, new (Symbols.CircleOpen, Colors.Green), "Green.A", "Crushing Regret Applied (Green)", "Crushing Regret Application", Sev0, 0),
                new EnemyCastStartMechanic([CrushingRegretNM, CrushingRegretEmpoweredNM, CrushingRegretCM, CrushingRegretEmpoweredCM], new (Symbols.CircleOpen, Colors.LightMilitaryGreen), "CrushReg.C", "Casted Crushing Regret", "Crushing Regret Cast", Sev3, 0),
                new EnemySrcEffectMechanic(EffectGUIDs.TempleOfFebeGreenSuccess, new (Symbols.Circle, Colors.Green), "CrushReg.C.S", "Crushing Regret Successful", "Success Crushing Regret", Sev0, 0),
                new EnemySrcEffectMechanic(EffectGUIDs.TempleOfFebeGreenFailure, new (Symbols.Circle, Colors.DarkRed), "CrushReg.C.F", "Crushing Regret Failed", "Failed Crushing Regret", Sev0, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([WailOfDespairNM, WailOfDespairCM], new (Symbols.Circle, Colors.LightOrange), "WailDesp.H", "Hit by Wail of Despair (Spread Player AoE)", "Wail of Despair Hit", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([WailOfDespairEmpoweredNM, WailOfDespairEmpoweredCM], new (Symbols.Circle, Colors.Orange), "Emp.WailDesp.H", "Hit by Empowered Wail of Despair (Spread Player AoE)", "Empowered Wail of Despair Hit", Sev0, 0),
                new EnemyCastStartMechanic([WailOfDespairNM, WailOfDespairEmpoweredNM, WailOfDespairCM, WailOfDespairEmpoweredCM], new (Symbols.CircleCrossOpen, Colors.LightOrange), "WailDesp.C", "Casted Wail of Despair", "Wail of Despair Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([PoolOfDespairNM, PoolOfDespairCM], new (Symbols.Circle, Colors.Red), "PoolDesp.H", "Hit by Pool of Despair (Spread Ground AoE)", "Pool of Despair Hit", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([PoolOfDespairEmpoweredNM, PoolOfDespairEmpoweredCM], new (Symbols.Circle, Colors.RedSkin), "Emp.PoolDesp.H", "Hit by Empowered Pool of Despair (Spread Ground AoE)", "Empowered Pool of Despair Hit", Sev0, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([EnviousGazeNM, EnviousGazeCM], new (Symbols.TriangleDown, Colors.Red), "EnvGaz.H", "Hit by Envious Gaze (Wall/Beam)", "Envious Gaze Hit", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([EnviousGazeEmpoweredNM, EnviousGazeEmpoweredRearNM, EnviousGazeEmpoweredCM, EnviousGazeEmpoweredRearCM], new (Symbols.TriangleUp, Colors.Red), "Emp.EnvGaz.H", "Hit by Empowered Envious Gaze (Double Wall/Beam)", "Empowered Envious Gaze Hit", Sev1, 0),
                new PlayerDstBuffRemoveMechanic(Boons, new (Symbols.Octagon, Colors.Purple), "EnvGaze.Strip", "Boons removed by Envious Gaze (Any)", "Envious Gaze Boon Removal", Sev0, 100)
                ...
                new EnemyCastStartMechanic([EnviousGazeNM, EnviousGazeCM, EnviousGazeEmpoweredNM, EnviousGazeEmpoweredCM], new (Symbols.TriangleDownOpen, Colors.Red), "EnvGaz.C", "Casted Envious Gaze", "Envious Gaze Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([MaliciousIntentSpawnDamageNM, MaliciousIntentSpawnDamageCM], new (Symbols.Y, Colors.White), "MalInt.H", "Hit by Malicious Intent (Malicious Shadow Spawn)", "Malicious Intent Hit", Sev1, 0),
                new PlayerDstBuffApplyMechanic([MaliciousIntentTargetBuff, MaliciousIntentTargetBuffCM], new (Symbols.Bowtie, Colors.DarkGreen), "MalInt.A", "Malicious Intent Target", "Targeted by Malicious Intent", Sev0, 0),
                new EnemyCastStartMechanic([MaliciousIntentNM, MaliciousIntentEmpoweredNM, MaliciousIntentCM, MaliciousIntentEmpoweredCM], new (Symbols.Bowtie, Colors.RedSkin), "MalInt.C", "Casted Malicious Intent", "Malicious Intent Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([CryOfRageNM, CryOfRageCM], new (Symbols.CircleX, Colors.LightOrange), "CryRage.H", "Hit by Cry of Rage", "Cry of Rage Hit", Sev0, 0),
                new PlayerDstHealthDamageHitMechanic([CryOfRageEmpoweredNM, CryOfRageEmpoweredCM], new (Symbols.CircleX, Colors.Orange), "Emp.CryRage.H", "Hit by Empowered Cry of Rage", "Empowered Cry of Rage Hit", Sev0, 0),
                new EnemyCastStartMechanic([CryOfRageNM, CryOfRageEmpoweredNM, CryOfRageCM, CryOfRageEmpoweredCM], new (Symbols.CircleOpenDot, Colors.LightOrange), "CryRage.C", "Casted Cry of Rage", "Cry of Rage Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([EnragedSmashNM, EnragedSmashCM], new (Symbols.Star, Colors.Red), "EnrSmash.H", "Hit by Enraged Smash", "Hit by Enraged Smash", Sev1, 0),
                new PlayerDstHealthDamageHitMechanic([EnragedSmashNM, EnragedSmashCM], new (Symbols.Star, Colors.DarkRed), "EnrSmash.D", "Downed to Enraged Smash", "Downed to Enraged Smash", Sev0, 0)
                    .UsingChecker((ahde, log) => ahde.HasDowned),
                new EnemyCastStartMechanic([EnragedSmashNM, EnragedSmashCM], new (Symbols.Star, Colors.Blue), "EnrSmash.C", "Casted Enraged Smash", "Enraged Smash Cast", Sev3, 0),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(PetrifyDamage, new (Symbols.Pentagon, Colors.Teal), "Pet.H", "Hit by Petrify", "Petrify Hit", Sev1, 0),
                new EnemyCastStartMechanic(PetrifySkill, new (Symbols.Pentagon, Colors.Yellow), "Pet.C", "Casted Petrify", "Petrify breakbar start", Sev3, 0),
                new EnemySrcHealthDamageHitMechanic(PetrifyDamage, new (Symbols.Pentagon, Colors.DarkTeal), "Pet.F", "Petrify hit players and healed Cerus", "Petrify breakbar fail", Sev0, 100),
            ]),

            new MechanicGroup([
                new AchievementEligibilityMechanic(Ach_UnboundedOptimism, new (Symbols.CircleOpenDot, Colors.DarkRedSkin), "UnbOpt.Achiv.L", "Achievement Eligibility: Unbounded Optimism Lost", "Unbounded Optimism Lost", 0)
                        .UsingChecker((evt, log) => evt.Lost),
                new AchievementEligibilityMechanic(Ach_UnboundedOptimism, new (Symbols.CircleOpenDot, Colors.RedSkin), "UnbOpt.Achiv.K", "Achievement Eligibility: Unbounded Optimism Kept", "Unbounded Optimism Kept", 0)
                        .UsingChecker((evt, log) => !evt.Lost)
            ]),
            new MechanicGroup([
                new EnemyDstBuffApplyMechanic(EmpoweredCerus, new (Symbols.Square, Colors.Red), "Emp.A", "Gained Empowered", "Empowered Application", Sev0, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredDespairCerus, new (Symbols.Square, Colors.Black), "EmpDesp.A", "Gained Empowered Despair", "Empowered Despair Application", Sev2, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredEnvyCerus, new (Symbols.Square, Colors.Blue), "EmpEnvy.A", "Gained Empowered Envy", "Empowered Envy Application", Sev2, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredGluttonyCerus, new (Symbols.Square, Colors.Brown), "EmpGlu.A", "Gained Empowered Gluttony", "Empowered Gluttony Application", Sev2, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredMaliceCerus, new (Symbols.Square, Colors.LightBlue), "EmpMal.A", "Gained Empowered Malice", "Empowered Malice Application", Sev2, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredRageCerus, new (Symbols.Square, Colors.LightOrange), "EmpRage.A", "Gained Empowered Rage", "Empowered Rage Application", Sev2, 0),
                new EnemyDstBuffApplyMechanic(EmpoweredRegretCerus, new (Symbols.Square, Colors.LightGrey), "EmpReg.A", "Gained Empowered Regret", "Empowered Regret Application", Sev2, 0),
            ]),
            new MechanicGroup([
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.LightRed), "Despair.K", "Embodiment of Despair Killed", "Despair Killed", Sev1, 0)
                ...
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.LightBlue), "Envy.K", "Embodiment of Envy Killed", "Envy Killed", Sev1, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfEnvy) && !bae.To.HasBuff(log, EmpoweredEnvyEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.LightOrange), "Gluttony.K", "Embodiment of Gluttony Killed", "Gluttony Killed", Sev1, 0)
                ...
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.LightGrey), "Malice.K", "Embodiment of Malice Killed", "Malice Killed", Sev1, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfMalice) && !bae.To.HasBuff(log, EmpoweredMaliceEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.LightPurple), "Rage.K", "Embodiment of Rage Killed", "Rage Killed", Sev1, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfRage) && !bae.To.HasBuff(log, EmpoweredRageEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.White), "Regret.K", "Embodiment of Regret Killed", "Regret Killed", Sev1, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfRegret) && !bae.To.HasBuff(log, EmpoweredRegretEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Red), "Emp.Despair.K", "Empowered Embodiment of Despair Killed", "Empowered Despair Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfDespair) && bae.To.HasBuff(log, EmpoweredDespairEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Blue), "Emp.Envy.K", "Empowered Embodiment of Envy Killed", "Empowered Envy Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfEnvy) && bae.To.HasBuff(log, EmpoweredEnvyEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Orange), "Emp.Gluttony.K", "Empowered Embodiment of Gluttony Killed", "Empowered Gluttony Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfGluttony) && bae.To.HasBuff(log, EmpoweredGluttonyEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Grey), "Emp.Malice.K", "Empowered Embodiment of Malice Killed", "Empowered Malice Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfMalice) && bae.To.HasBuff(log, EmpoweredMaliceEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Purple), "Emp.Rage.K", "Empowered Embodiment of Rage Killed", "Empowered Rage Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfRage) && bae.To.HasBuff(log, EmpoweredRageEmbodiment, bae.Time)),
                new EnemyDstBuffApplyMechanic(Invulnerability757, new (Symbols.StarOpen, Colors.Black), "Emp.Regret.K", "Empowered Embodiment of Regret Killed", "Empowered Regret Killed", Sev0, 0)
                    .UsingChecker((bae, log) => bae.To.IsSpecies(TargetID.EmbodimentOfRegret) && bae.To.HasBuff(log, EmpoweredRegretEmbodiment, bae.Time)),
