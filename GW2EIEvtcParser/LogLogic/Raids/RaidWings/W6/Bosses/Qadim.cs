...
internal class Qadim : MythwrightGambit
{
    internal readonly MechanicGroup Mechanics = new([
            new MechanicGroup([
                new EnemyCastStartMechanic(QadimCC, new (Symbols.StarDiamond,Colors.DarkTeal), "Q.CC", "Qadim CC","Qadim CC", Sev3),
                new EnemyCastEndMechanic(QadimCC, new (Symbols.StarDiamond,Colors.DarkGreen), "Q.CCed", "Qadim Breakbar broken","Qadim CCed", Sev0)
                    .UsingChecker((ce, log) => ce.ActualDuration < 6500),
                new EnemyCastStartMechanic(QadimRiposte, new (Symbols.StarDiamond,Colors.DarkRed), "Q.CC Fail", "Qadim Breakbar failed","Qadim CC Fail", Sev0),
                new PlayerDstHealthDamageHitMechanic(QadimRiposte, new (Symbols.Circle,Colors.Magenta), "NoCC Attack", "Riposte (Attack if CC on Qadim failed)", "Riposte (No CC)", Sev1),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([ FieryDance1, FieryDance2, FieryDance3, FieryDance4 ], new (Symbols.BowtieOpen,Colors.Orange), "F.Dance", "Fiery Dance (Fire running along metal edges)", "Fire on Lines", Sev2),
                new PlayerDstHealthDamageHitMechanic(SeaOfFlame, new (Symbols.CircleOpen,Colors.Red), "Q.Hitbox", "Sea of Flame (Stood in Qadim Hitbox)","Qadim Hitbox AoE", Sev1),
                new PlayerDstHealthDamageHitMechanic(ShatteringImpact, new (Symbols.Circle,Colors.Yellow), "Stun", "Shattering Impact (Stunning flame bolt)","Flame Bolt Stun", Sev0),
                new PlayerDstHealthDamageHitMechanic(FlameWave, new (Symbols.StarTriangleUpOpen,Colors.Pink), "KB", "Flame Wave (Knockback Frontal Beam)","KB Push", Sev0)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic(FireWaveQadim, new (Symbols.CircleOpen,Colors.Orange), "Q.Wave", "Fire Wave (Shockwave after Qadim's Mace attack)","Mace Shockwave", Sev1),
                new PlayerDstHealthDamageHitMechanic(BigHit, new (Symbols.Circle,Colors.Red), "Mace", "Big Hit (Mace Impact)","Mace Impact", Sev1),
                new PlayerDstHealthDamageHitMechanic(Inferno, new (Symbols.TriangleDownOpen,Colors.Red), "Inf.", "Inferno (Lava Pool drop  on long platform spokes)","Inferno Pool", Sev1),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(ElementalBreath, new (Symbols.TriangleLeft,Colors.Red), "Hydra Breath", "Elemental Breath (Hydra Breath)","Hydra Breath", Sev0),
                new PlayerDstHealthDamageHitMechanic(Fireball, new (Symbols.CircleOpen,Colors.Yellow,10), "H.FBall", "Fireball (Hydra)","Hydra Fireball", Sev2),
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic(FieryMeteor, new (Symbols.CircleOpen,Colors.Pink), "H.Meteor", "Fiery Meteor (Hydra)","Hydra Meteor", Sev1),
                    new EnemyCastStartMechanic(FieryMeteor, new (Symbols.DiamondTall,Colors.DarkTeal), "H.CC", "Fiery Meteor (Hydra Breakbar)","Hydra CC", Sev3),
                    ...
                    new EnemyCastEndMechanic(FieryMeteor, new (Symbols.DiamondTall,Colors.DarkGreen), "H.CCed", "Fiery Meteor (Hydra Breakbar broken)","Hydra CCed", Sev0)
                        .UsingChecker((ce, log) => ce.ActualDuration < 12364),
                    new EnemyCastEndMechanic(FieryMeteor, new (Symbols.DiamondTall,Colors.DarkRed), "H.CC Fail", "Fiery Meteor (Hydra Breakbar not broken)","Hydra CC Failed", Sev0)
                        .UsingChecker((ce,log) => ce.ActualDuration >= 12364),
                ]),
                new PlayerDstHealthDamageHitMechanic(TeleportHydra, new (Symbols.Circle,Colors.Purple), "H.KB", "Teleport Knockback (Hydra)","Hydra TP KB", Sev2),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(FireWaveDestroyer, new (Symbols.CircleOpen,Colors.DarkRed), "D.Wave", "Fire Wave (Shockwave after Destroyer's Jump or Stomp)","Destroyer Shockwave", Sev1)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic(SeismicStomp, new (Symbols.StarOpen,Colors.Yellow), "D.Stomp", "Seismic Stomp (Destroyer Stomp)","Seismic Stomp (Destroyer)", Sev2),
                new PlayerDstHealthDamageHitMechanic(ShatteredEarth, new (Symbols.HexagramOpen,Colors.Red), "D.Slam", "Shattered Earth (Destroyer Jump Slam)","Jump Slam (Destroyer)", Sev2),
                new PlayerDstHealthDamageHitMechanic(WaveOfForce, new (Symbols.DiamondOpen,Colors.Orange), "D.Pizza", "Wave of Force (Destroyer Pizza)","Destroyer Auto", Sev3),
                new MechanicGroup([
                    new EnemyCastStartMechanic(SummonDestroyer, new (Symbols.StarTriangleDown,Colors.DarkTeal), "D.CC", "Summon (Destroyer Breakbar)","Destroyer CC", Sev3),
                    new EnemyCastEndMechanic(SummonDestroyer, new (Symbols.StarTriangleDown,Colors.DarkGreen), "D.CCed", "Summon (Destroyer Breakbar broken)","Destroyer CCed", Sev0).UsingChecker((ce, log) => ce.ActualDuration < 8332),
                    new EnemyCastEndMechanic(SummonDestroyer, new (Symbols.StarTriangleDown,Colors.DarkRed), "D.CC Fail", "Summon (Destroyer Breakbar failed)","Destroyer CC Fail", Sev0).UsingChecker((ce,log) => ce.ActualDuration >= 8332),
                    new SpawnMechanic(SummonSpawn, new (Symbols.DiamondWide,Colors.DarkRed), "D.Spwn", "Summon (Destroyer Trolls summoned)","Destroyer Summoned", Sev1),
                ]),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SlashWyvern, new (Symbols.TriangleDownOpen,Colors.Yellow), "Slash", "Wyvern Slash (Double attack: knock into pin down)","KB/Pin down", Sev0)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic(TailSwipe, new (Symbols.DiamondOpen,Colors.Yellow), "W.Pizza", "Wyvern Tail Swipe (Pizza attack)","Tail Swipe", Sev1),
                new PlayerDstHealthDamageHitMechanic(FireBreath, new (Symbols.TriangleRightOpen,Colors.Orange), "W.Breath", "Fire Breath (Wyvern)","Fire Breath", Sev2),
                new PlayerDstHealthDamageHitMechanic(WingBuffet, new (Symbols.StarDiamondOpen,Colors.DarkTeal), "W.Wing", "Wing Buffet (Wyvern Launching Wing Storm)","Wing Buffet", Sev0),
                new MechanicGroup([
                    new EnemyCastStartMechanic(PatriarchCC, new (Symbols.StarSquare,Colors.DarkTeal), "W.BB", "Platform Destruction (Patriarch CC)","Patriarch CC", Sev3),
                    new EnemyCastEndMechanic(PatriarchCC, new (Symbols.StarSquare,Colors.DarkGreen), "W.CCed", "Platform Destruction (Patriarch Breakbar broken)","Patriarch CCed", Sev0)
                        .UsingChecker((ce, log) => ce.ActualDuration < 6500),
                    new EnemyCastStartMechanic(PatriarchCCJumpInAir, new (Symbols.StarSquare,Colors.DarkRed), "Wyv CC Fail", "Platform Destruction (Patriarch Breakbar failed)","Patriarch CC Fail", Sev0),
                ]),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(SwapQadim, new (Symbols.CircleCrossOpen,Colors.Magenta), "Port", "Swap (Ported from below Legendary Creature to Qadim)","Port to Qadim", Sev3),
                new PlayerDstBuffApplyMechanic(PowerOfTheLamp, new (Symbols.TriangleUp,Colors.LightPurple,10), "Lamp", "Power of the Lamp (Returned from the Lamp)","Lamp Return", Sev1),
                new MechanicGroup([
                ...
                new PlayerDstHealthDamageHitMechanic(Claw, new (Symbols.TriangleLeftOpen,Colors.DarkTeal,10), "Claw", "Claw (Reaper of Flesh attack)","Reaper Claw", Sev2),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(BodyOfFlame, new (Symbols.StarOpen,Colors.Pink,10), "P.AoE", "Body of Flame (Pyre Ground AoE (CM))","Pyre Hitbox AoE", Sev1),
