...
internal class GreerTheBlightbringer : MountBalrior
{
    ...
    internal readonly MechanicGroup Mechanics = new([
            new MechanicGroup([
                new PlayerSrcHealthDamageHitMechanic(ReflectableProjectiles, new (Symbols.YDown, Colors.Pink), new("ProjRefl.Greer.H", "Reflected projectiles have hit Greer", "Reflected Projectile Hit (Greer)"), Sev0)
                ...
                new PlayerSrcHealthDamageHitMechanic(ReflectableProjectiles, new (Symbols.YDown, Colors.Purple), new("ProjRefl.Reeg.H", "Reflected projectiles have hit Reeg", "Reflected Projectile Hit (Reeg)"), Sev1)
                    .UsingChecker((hde, log) => hde.To.IsSpecies(TargetID.Reeg))
                    .WithBuilds(GW2Builds.November2024MountBalriorRelease, GW2Builds.December2024MountBalriorNerfs),
                new PlayerSrcHealthDamageHitMechanic(ReflectableProjectiles, new (Symbols.YDown, Colors.LightPurple), new("ProjRefl.Gree.H", "Reflected projectiles have hit Gree", "Reflected Projectile Hit (Gree)"), Sev1)
                    .UsingChecker((hde, log) => hde.To.IsSpecies(TargetID.Gree))
                    .WithBuilds(GW2Builds.November2024MountBalriorRelease, GW2Builds.December2024MountBalriorNerfs),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([RotTheWorld, RotTheWorldCM], new (Symbols.Star, Colors.Teal), new("RotWorld.H", "Hit by Rot the World (Breakbar AoEs)", "Rot the World Hit"), Sev2, 50),
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic([EruptionOfRot, EruptionOfRot2, EruptionOfRot3, EruptionOfRot4, EruptionOfRot5, EruptionOfRot6], new (Symbols.Hexagram, Colors.GreenishYellow), new("ErupRot.H", "Hit by Eruption of Rot", "Eruption of Rot Hit"), Sev2),
                    new PlayerDstHealthDamageHitMechanic([RotEruption, RotEruptionCM], new (Symbols.TriangleSEOpen, Colors.DarkBlue), new("RotErup", "Hit by Rot Eruption", "Rot Eruption Hit"), Sev2),
                    new PlayerDstBuffApplyMechanic(EruptionOfRotBuff, new (Symbols.StarTriangleDown, Colors.LightBrown), new("ErupRot.S", "Stood in Eruption of Rot (Green)", "Stood in Eruption of Rot"), Sev2),
                    new PlayerDstBuffApplyMechanic(EruptionOfRotBuff, new (Symbols.StarTriangleDownOpen, Colors.LightBrown), new("ErupRot.Dwn", "Downed by stacking Eruption of Rot (Green)", "Downed by Eruption of Rot"), Sev0)
                        .UsingChecker((bae, log) => bae.To.IsDowned(log, bae.Time)),
                    new PlayerDstEffectMechanic([EffectGUIDs.GreerEruptionOfRotGreen, EffectGUIDs.GreerEruptionOfRotGreen2, EffectGUIDs.GreerEruptionofRotGreen3], new (Symbols.Circle, Colors.Green), new("ErupRot.T", "Targeted by Eruption of Rot (Green)", "Eruption of Rot (Green)"), Sev1),
                ]),
                new PlayerDstHealthDamageHitMechanic([RipplesOfRot, RipplesOfRot2, RipplesOfRotCM, RipplesOfRotCM2], new (Symbols.StarSquareOpenDot, Colors.Chocolate), new("RippRot.H", "Hit by Ripples of Rot", "Ripples of Rot Hit"), Sev1),
                new PlayerDstBuffApplyMechanic(PlagueRot, new (Symbols.YDown, Colors.Red), new("PlagueRot", "Received Plague Rot", "Plague Rot"), Sev0),
                new MechanicGroup([
                    new AchievementEligibilityMechanic(Ach_Unplagued, new (Symbols.YDown, Colors.DarkYellow), new("Unplagued.Achiv.L", "Achievement Eligibility: Guaranteed Plague Free Lost", "Achiv Unplagued Lost"))
                        .UsingChecker((evt, log) => evt.Lost),
                    new AchievementEligibilityMechanic(Ach_Unplagued, new (Symbols.YDown, Colors.Yellow), new("Unplagued.Achiv.K", "Achievement Eligibility: Guaranteed Plague Free Kept", "Achiv Unplagued Kept"))
                        .UsingChecker((evt, log) => !evt.Lost)
                ]),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([RakeTheRot, RakeTheRot2, RakeTheRot3], new (Symbols.PentagonOpen, Colors.LightBlue), new("Rake.H", "Hit by Rake the Rot", "Rake the Rot Hit"), Sev0)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic([SweepTheMold, SweepTheMold2, SweepTheMold3], new (Symbols.PentagonOpen, Colors.Blue), new("Sweep.H", "Hit by Sweep the Mold", "Sweep the Mold Hit"), Sev0)
                    .UsingBuffChecker(Stability, false),
                new PlayerDstHealthDamageHitMechanic([StompTheGrowth, StompTheGrowth2, StompTheGrowth3], new (Symbols.CircleOpen, Colors.LightOrange), new("Stomp.H", "Hit by Stomp the Growth", "Stomp the Growth Hit"), Sev2),
                new PlayerDstHealthDamageHitMechanic(WaveOfCorruption, new (Symbols.HourglassOpen, Colors.LightRed), new("WaveCor.H", "Hit by Wave of Corruption", "Wave of Corruption Hit"), Sev1),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([SeedsOfDecay, SeedsOfDecay2, SeedsOfDecay3], new (Symbols.TriangleLeftOpen, Colors.Sand), new("SeedsDec.H", "Hit by Seeds of Decay (Greer's Armor Falling)", "Seeds of Decay Hit"), Sev3),
                new PlayerDstHealthDamageHitMechanic([CageOfDecay, CageOfDecay2, CageOfDecay3, CageOfDecay4, CageOfDecay5], new (Symbols.Hourglass, Colors.LightPurple), new("Cage.H", "Hit by Cage of Decay", "Cage of Decay Hit"), Sev1, 50),
            ]),
            new EnemyCastStartMechanic(TheWorldEndsInDecay, new (Symbols.X, Colors.DarkRed), new("Enrage", "The World Ends in Decay (Enrage)", "The World Ends in Decay (Enrage)"), Sev0),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([RainOfSpores, RainOfSpores2], new (Symbols.Hexagon, Colors.Green), new("RainSpore.H", "Hit by Rain of Spores", "Rain of Spores Hit"), Sev0, 50),
                new PlayerDstHealthDamageHitMechanic([ScatteringSporeblast, ScatteringSporeblast2], new (Symbols.SquareOpen, Colors.GreenishYellow), new("ScatSpore.H", "Hit by Scattering Sporeblast", "Scattering Sporeblast Hit"), Sev1, 50),
            ]),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(InfectiousRotBuff, new (Symbols.CircleX, Colors.Red), new("InfRot.T", "Targeted by Infectious Rot (Hit by Noxious Blight)", "Infectious Rot Target"), Sev0),
                new PlayerDstHealthDamageHitMechanic([NoxiousBlight, NoxiousBlight2, NoxiousBlightCM, NoxiousBlightCM2], new (Symbols.TriangleNEOpen, Colors.DarkPink), new("NoxBlight.H", "Hit by Noxious Blight", "Noxious Blight Hit"), Sev1),
            ]),
            new PlayerDstHealthDamageHitMechanic([EnfeeblingMiasma, EnfeeblingMiasma2, EnfeeblingMiasma3, EnfeeblingMiasma4], new (Symbols.TriangleDown, Colors.LightPurple), new("EnfMiasma.H", "Hit by Enfeebling Miasma", "Enfeebling Miasma Hit"), Sev1),
            new PlayerDstHealthDamageHitMechanic([AuraOfCorruptionDamage_ReegGreeEreg, AuraOfCorruptionDamage_Greer], new (Symbols.CircleOpenDot, Colors.Purple), new("AuraCorr.H", "Hit by Aura of Corruption (Hitbox)", "Aura of Corruption Hit"), Sev3),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic([BlobOfBlight, BlobOfBlight2, BlobOfBlight3], new (Symbols.Star, Colors.CobaltBlue), new("BlobBlight.H", "Hit by Blob of Blight", "Blob of Blight Hit"), Sev0),
                new PlayerDstBuffApplyMechanic(TargetBuff, new (Symbols.CircleXOpen, Colors.LightBlue), new("BlobBlight.T", "Targeted by Blob of Blight", "Blob of Blight Target"), Sev1),
            ]),
            new PlayerDstBuffRemoveMechanic(Boons, new (Symbols.Octagon, Colors.Purple), new("BoonCorrupt", "Boons corrupted (any)", "Boons Corrupted"), Sev0, 100)
                .UsingChecker((brae, log) => brae.By.IsAnySpecies([(int)TargetID.Greer, (int)TargetID.Gree, (int)TargetID.Reeg, (int)TargetID.Ereg])),
            new EnemyDstBuffApplyMechanic(EmpoweredGreer, new (Symbols.YUp, Colors.Red), new("Empowered", "Gained Empowered", "Empowered"), Sev0),
        ]);
